...
const TIPS = [
  ...
  "Use {highlight}/export{/highlight} to save a conversation locally",
  ...
  "Place TUI settings in your Fabi config directory for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Fabi auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Fabi auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Fabi uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Fabi from reading sensitive files",
  "Use {highlight}fabi run{/highlight} for non-interactive scripting",
  "Use {highlight}fabi --continue{/highlight} to resume the last session",
  "Use {highlight}fabi run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}fabi serve{/highlight} for headless API access to Fabi",
  "Use {highlight}fabi run --attach{/highlight} to connect to a running server",
  "Run {highlight}fabi upgrade{/highlight} to update to the latest version",
  "Run {highlight}fabi auth list{/highlight} to see all configured providers",
  "Run {highlight}fabi agent create{/highlight} for guided agent creation",
  "Use Fabi from GitHub issues/PRs when the GitHub workflow is configured",
  "Run {highlight}fabi github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/fabi fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}fabi debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} to configure external providers",
